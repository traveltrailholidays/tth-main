    ...
    <Accordion type="single" collapsible className="w-full">
      <div className={`flex flex-col gap-5`}>
        <AccordionItem value="item-1" className={`border-none`}>
          <AccordionTrigger className={`hover:no-underline bg-light_secondBg dark:bg-dark_secondBg px-5 rounded-md`}>
              Pay in Account
          </AccordionTrigger>
          <AccordionContent>
            <div className="mt-2 border-[0.125rem] rounded-md border-gray-300 dark:border-gray-600">
              <div className={`p-12`}>
                <div className={`${styles.text_primary} font-semibold text-[18px]`}>
                ...
                <div className={`text-[17px] mt-5 flex flex-col gap-2`}>
                  ...
                  <div>
                    <span className={`font-[500]`}>UPI No: </span>
