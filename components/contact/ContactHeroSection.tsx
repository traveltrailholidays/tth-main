...
export default function ContactHeroSection() {
  return (
    <section className={`mt-20`}>
        <div className={`larger_screen w-full h-[200px] md:h-[400px] relative`}>
            ...
            <div className="absolute w-full h-full top-0 flex flex-col gap-10 justify-center items-center">
                <span className={`${styles.reem_kufi} ${styles.hero_heading} text-white font-semibold`}>Contact Us</span>
            </div>
        </div>
    </section>
  )
