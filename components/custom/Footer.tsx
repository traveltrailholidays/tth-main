    ...
    >
      ...
      >
        ...
        <div className={`w-[95%] flex justify-between pt-10 pb-5 flex-wrap gap-10 `}>
          ...
          <div className={`max-w-[410px]`}>
            ...
            <div className="flex items-center gap-1">
                ...
                <div className="flex items-center gap-1">
                  <ArrowRightSolid height="0.7rem" width="0.7rem" fillColor="#cbd5e0" strokeWidth="0" strokeColor="currentColor"/>
                  <Navlink href="/dehradun" exact  className={``}>
                    <span>Dehradun</span>
                  </Navlink>
                </div>
                <div className="flex items-center gap-1">
          ...
          <div className={`max-w-[410px]`}>
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Navlink href="/dehradun" exact className={`flex w-full`}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Navlink href={`/about`} exact className={`flex w-full`}>
        ...
        <div className={`pt-5 w-full flex justify-between md:pb-5 mb-20 md:mb-0 flex-col text-center md:flex-row items-center gap-2`}>
          ...
          <span className={``}>
            <span>Designed with <span className={`${styles.text_primary} text-lg select-none`}>&#x2665;</span> by <Link href={diwakarjha!} target="_blank" className={`hover:underline`}>iamdkjha</Link></span>
          </span>
        </div>
