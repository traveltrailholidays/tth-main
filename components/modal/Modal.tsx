...
import Button from "@/components/ui/feature/Button";
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div
                        className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-light_bg dark:bg-dark_bg outline-none focus:outline-none"
                    >
